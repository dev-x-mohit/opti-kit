      ...
      <main className="flex-1 max-w-4xl pt-6 pr-0 lg:pr-6 space-y-16">
        ...
        <section id="getting-started" className="scroll-mt-24 border-b border-border/60 pb-12">
          ...
          <p className="text-lg text-muted leading-relaxed mb-6">
            OptiKit is a zero-dependency, ultra-lightweight, and fully tree-shakeable utility library engineered for modern TypeScript and JavaScript applications. Designed to replace legacy monoliths like Lodash, it ships 25 modules and 328+ utilities in a dual CJS/ESM package.
          </p>
